...
import com.haneet.wheelwidget.R;
...
public class LTSpinningWheelView extends View implements WheelRotation.RotationListener {
    ...
    private final static int TEXT_COLOR = Color.TRANSPARENT;

    private final static int ARROW_COLOR = Color.TRANSPARENT;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                onRotationListener.onRotation(ResultAngle);
                break;
        }
    ...
    public interface OnRotationListener<T> {
        ...
        void onStopRotation(Point item);
    }
